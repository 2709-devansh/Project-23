...
function setup() {
	...
	box2Sprite = createSprite(570, 610,20,100);
	box2Sprite.shapeColor = "red";

	box3Sprite = createSprite(770, 610,20,100);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 box2 = Bodies.rectangle(570,610,20,100, {isStatic: true});
	 World.add(world, box2);

	 box3 = Bodies.rectangle(770,610,20,100, {isStatic: true});
